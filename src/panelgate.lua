...
-- Clear the baseline so the next post is never suppressed. main.lua calls
-- this when the panel leaves "rooms" mode (a terrain frame switches it to
-- map mode): the next scored-room list must post to switch the panel back,
-- even if it's identical to the list shown before the panel went to terrain.
